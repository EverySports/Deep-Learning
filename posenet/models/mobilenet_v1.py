...
class MobileNetV1(tf.keras.Model):
    def __init__(self, model_id='mobilenet_v1', input_shape=(256, 256, 3), output_stride=16):
        ...
        self.conv1 = DepthwiseConvBlock(1024)
        self.dconv1 = Conv2DTranspose(1024, 3, strides=2, padding='same')
        self.bn1 = BatchNormalization()
        self.conv2 = DepthwiseConvBlock(1024)
        self.conv3 = DepthwiseConvBlock(1024)
        self.dconv2 = Conv2DTranspose(1024, 3, strides=2, padding='same')
        self.bn2 = BatchNormalization()
        self.conv4 = DepthwiseConvBlock(1024)
        self.conv5 = DepthwiseConvBlock(1024)

        self.heatmap_conv1 = DepthwiseConvBlock(512)
        self.heatmap_conv2 = DepthwiseConvBlock(256)
        self.heatmap = Conv2D(17, 3, 1, activation='sigmoid', padding='same')

        self.offset_conv1 = DepthwiseConvBlock(512)
        self.offset_conv2 = DepthwiseConvBlock(256)
